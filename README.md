...
Then just run this before you open Rocket League and it will detect new replay files and upload them for you. They will be uploaded with public visibility, I might add a toggle to this at a later date.
